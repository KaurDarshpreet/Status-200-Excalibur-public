...
const SignUp = () => {
    ...
    const [studentPhoto, setStudentPhoto] = useState('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJYb2zspz6ROyH52cwdtHhexhhdWTAH-UtptMHckW6IQ&s');
        ...
        case 'student':
            content = <>
                ...
                <form action="" className="flex flex-col m-2 h-full">
                    <label htmlFor="photo">
                        <img src={studentPhoto} alt="profile" className="w-[8rem] h-[8rem] rounded-full mx-auto my-1 bg-slate-500 cursor-pointer" />
                    </label>
