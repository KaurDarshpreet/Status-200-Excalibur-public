...
const HostelAdminProfile = () => {
    ...
    return (
        <div className="profile flex flex-col items-center gap-2 bg-black min-w-[20svw] h-max mb-auto mt-2 rounded-lg p-4">
            ...
            <div className="profile_info flex flex-col items-center gap-4">
                ...
                <p className="text-lg text-white font-bold">Hostel No  <span className='text-2xl bg-yellow-400 text-slate-700 ml-2 px-1 rounded-md py-0'>{hostelDetails.hostelNo}</span></p>
            </div>
